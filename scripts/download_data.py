...
def main():
  parser = argparse.ArgumentParser(description='Download text files from a Hugging Face dataset repo.')
  parser.add_argument(
    '--repo-id',
    required=True,
  ...
  parser.add_argument(
    '--prefix',
    required=True,
    help=("Filename prefix in the repo, e.g. 'TinyStories' or 'TinyStoriesV2-GPT4'; script will fetch PREFIX-train.txt and/or PREFIX-valid.txt"),
  )
  parser.add_argument(
    '--split',
